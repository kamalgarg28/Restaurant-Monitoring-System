...
class StoreViewSet(ModelViewSet):
    ...
    def trigger_report(self, request,pk):
        ...
        async_task('main.helper.trigger_report_combined', report, )
    ...
    def get_report(self, request):
        ...
        if report.status == ReportStatus.COMPLETED:
            ...
            return Response(status=200,data={"status": "Complete", "report_url": report_url, "message":"Copy and past report_url in browser to download the report."})
        else:
